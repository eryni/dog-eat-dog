    ...
    return [
      {
        ...
        color: "Golden",
        weight: 30.5,
        photoUrl: "assets/portraits/Max.jpg",
      ...
      },
      {
        ...
        color: "Golden",
        weight: 3.5,
        photoUrl: "assets/portraits/Bella.jpg",
        healthStatus: "Healthy",
        vaccinationStatus: "Complete",
        dewormed: true,
        neuteredSpayed: false,
      ...
      },
      {
        ...
        color: "Dark & Brown",
        weight: 50.0,
        photoUrl: "assets/portraits/Rocky.jpg",
        healthStatus: "Healthy",
        vaccinationStatus: "Complete",
        dewormed: true,
        neuteredSpayed: true,
      ...
      },
      {
        ...
        color: "Cream & Brown",
        weight: 5.0,
        photoUrl: "assets/portraits/Luna.jpg",
        healthStatus: "Healthy",
        vaccinationStatus: "Complete",
        dewormed: true,
        neuteredSpayed: true,
      ...
      },
      {
        ...
        color: "Grey",
        weight: 0.9,
        photoUrl: "assets/portraits/Polly.jpg",
        healthStatus: "Healthy",
        vaccinationStatus: "Complete",
        dewormed: true,
        neuteredSpayed: false,
